...
CLIENT_SEMANTICS_SPECIAL_NOTES = {
    ...
    "s2c-0193": (
        ...
        "subop_routes=0x00..0x0f write a u32 vector at index subopcode through FUN_0075F3E0; "
        "the runtime-length error path still reaches the raw write; paired reader=FUN_0075F420; "
        "0x10/0x11/0x12/0x16 write same-owner u32 slots "
        "+0x10/+0x14/+0x18/+0x1c with paired readers FUN_0075D220/FUN_0075D240/"
        "FUN_0075D260/FUN_0075D280, 0x13 queries or writes ActionCheck u32 +0x38, "
        ...
        "corpus_aggregate=9 events; unresolved=final +0x17758 base ownership, individual "
        "low-vector meanings, semantic timer-field names, exact command membership of all four groups, "
        "external ActionCheck consumer; first_reader_wrappers=FUN_00705450,FUN_007054D0,"
        ...
        "timer/config/command route does not establish server behavior or login causality; "
