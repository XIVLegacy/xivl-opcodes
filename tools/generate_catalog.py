...
CLIENT_SEMANTICS_SPECIAL_NOTES = {
    ...
    "s2c-018a": (
        ...
        "consumer_boundary=no Group::SharedWork virtual call and the first unresolved boundary "
        "is the persistent map's non-mutating consumer and both field domains; "
        ...
        "reconciliation does not establish server behavior; "
